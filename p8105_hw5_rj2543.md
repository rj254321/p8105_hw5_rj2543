...
**Raw data has 52179 rows for different observations. And 12 columns referred to uid, reported\_date, victim\_last, victim\_first, victim\_race, victim\_age, victim\_sex, city, state, lat, lon, disposition variables.**
